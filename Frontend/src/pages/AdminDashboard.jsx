                ...
                <div className="p-8 max-w-7xl mx-auto space-y-10">
                        ...
                        {loadingOverview ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                                    <StatCard label="Total Students" value={overview.totals.totalStudents} color="text-blue-600" sub={`+${overview.newRegistrations.studentsThisMonth} this month`} />
                                    <StatCard label="Total Teachers" value={overview.totals.totalTeachers} color="text-green-600" sub={`+${overview.newRegistrations.teachersThisMonth} this month`} />
                                    <StatCard label="Total Streams" value={overview.totals.totalStreams} color="text-purple-600" />
                                    <StatCard label="Total Subjects" value={overview.totals.totalSubjects} color="text-orange-500" />
                                </div>

                                {/* Highlights */}
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                                    <StatCard label="New Students (Week)" value={overview.newRegistrations.studentsThisWeek} color="text-blue-500" />
                                    <StatCard label="New Teachers (Week)" value={overview.newRegistrations.teachersThisWeek} color="text-green-500" />
                                    <StatCard label="Active Students (30d)" value={overview.recentlyActiveStudents} color="text-indigo-600" sub="Registered in last 30 days" />
                                    <StatCard label="Google Calendar Integrations" value={overview.googleCalendarIntegrations} color="text-teal-600" sub="Students connected" />
                                </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-4">
                                            <StatCard label="Groq Total" value={overview.aiUsage.groqTotal} color="text-violet-600" sub={`Quizzes: ${overview.aiUsage.groqQuizzes} · Plans: ${overview.aiUsage.groqStudyPlans}`} />
                                            <StatCard label="Gemini Total" value={overview.aiUsage.geminiTotal} color="text-pink-600" />
                                        </div>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <Link to="/admin/teachers" className="group bg-white p-6 rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 hover:border-blue-300">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center text-white shadow-lg">
                                        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                                    </div>
                                    <svg className="w-6 h-6 text-gray-400 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                </div>
                                <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">Manage Teachers</h3>
                            ...
                            <Link to="/admin/students" className="group bg-white p-6 rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 hover:border-green-300">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center text-white shadow-lg">
                                        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /></svg>
                                    </div>
                                    <svg className="w-6 h-6 text-gray-400 group-hover:text-green-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                </div>
                                <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-green-600 transition-colors">Manage Students</h3>
                            ...
                            <Link to="/admin/analytics" className="group bg-gradient-to-br from-purple-500 to-pink-600 p-6 rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 text-white">
                                <div className="flex items-center justify-between mb-4">
